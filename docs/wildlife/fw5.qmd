...
library(tbeptools)
load(file = here::here('data/tbniscr.RData'))  
```
...
![The Tampa Bay Nekton Index over time in each of the major bay segments. SOURCE: TBEP](https://raw.githubusercontent.com/tbep-tech/state-of-the-bay/master/figures/tbnireport.jpg){width=40% fig-align="center"}
